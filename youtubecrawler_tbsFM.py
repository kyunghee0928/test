...
driver.find_element_by_xpath('/html/body/ytd-app/ytd-popup-container/iron-dropdown/div/ytd-multi-page-menu-renderer/div[4]/ytd-multi-page-menu-renderer/div[3]/div[1]/ytd-account-section-list-renderer/div/ytd-account-item-section-renderer/div/ytd-account-item-renderer[2]').click()
time.sleep(5)
...
result = {"subscription":subs.text.strip(), "ch":'tbsFM'}

RESULT_PATH = 'C:/1.crwaling data/youtube/'
OUTPUT_FILENAME = 'tbsFM_YOUTUBE.csv'
